...
{
    public class TransactionDeliveryNationController : BaseController
    {
        ...
        public ActionResult Index()
        {
            ...
            ViewBag.roleLoginTranDeliveryNation = UserLogins.Role;
        ...
        public PartialViewResult SearchTransactionDelivery(int page, int? status, int? provinceID, int? districtID, int? transportType,int? isVip, string searchKey = "", string fromDate = "", string toDate = "")
        {
            try
            {
                var listcate = transactionDeliveryBusiness.SearchTransactionDelivery(page, searchKey, provinceID, districtID, fromDate, toDate, status, transportType,SystemParam.OUT_PROVINCE, isVip);
        ...
        public ActionResult ExportExcelTransactionDelivery(string searchKey, int? provinceID, int? districtID, string fromDate, string toDate, int? status, int? transportType, int? isVip)
        {
            ...
            List<TransactionDeliveryModel> FileData = transactionDeliveryBusiness.DataExcel(searchKey, provinceID, districtID, fromDate, toDate, status, transportType,SystemParam.OUT_PROVINCE, isVip);
            try
            {
