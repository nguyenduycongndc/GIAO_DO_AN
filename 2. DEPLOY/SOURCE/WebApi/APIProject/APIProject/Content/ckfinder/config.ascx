...
<script runat="server">
    ...
    public override void SetConfig()
    {
        ...
        LicenseName = "vinhnk";
        LicenseKey = "FS6Q524A4NKEHYGMDCPG4ARQKQASM4QL";

        // The base URL used to reach files in CKFinder through the browser.
        BaseUrl = "http://" + HttpContext.Current.Request.Url.Authority + "/Uploads/";
        ...
        //Images = DateTime.Now.ToString("yyyyMMddHHmmssfff");
