...
(function (window, undefined) {
    ...
    jQuery.ajax = function (url, options) {
        /// <summary>
        ///     Perform an asynchronous HTTP (Ajax) req.
        ///     &#10;1 - jQuery.ajax(url, settings) 
        ///     &#10;2 - jQuery.ajax(settings)
        /// </summary>
        /// <param name="url" type="String">
        ///     A string containing the URL to which the req is sent.
        /// </param>
        /// <param name="options" type="PlainObject">
        ///     A set of key/value pairs that configure the Ajax req. All settings are optional. A default can be set for any option with $.ajaxSetup(). See jQuery.ajax( settings ) below for a complete list of all settings.
        /// </param>
        ...
        // A cross-domain req is in order when we have a protocol:host:port mismatch
        ...
        // If req was aborted inside a prefilter, stop there
        if (state === 2) {
            return jqXHR;
        }
    ...
    jQuery.ajaxPrefilter = function (dataTypeExpression, func) {
        /// <summary>
        ///     Handle custom Ajax options or modify existing options before each req is sent and before they are processed by $.ajax().
        /// </summary>
    ...
    jQuery.ajaxSetup = function (target, settings) {
        ...
        ///     A set of key/value pairs that configure the default Ajax req. All options are optional.
        /// </param>
    ...
    jQuery.get = function (url, data, callback, type) {
        /// <summary>
        ///     Load data from the server using a HTTP GET req.
        /// </summary>
        /// <param name="url" type="String">
        ///     A string containing the URL to which the req is sent.
        /// </param>
        /// <param name="data" type="String">
        ///     A plain object or string that is sent to the server with the req.
        /// </param>
        /// <param name="callback" type="Function">
        ///     A callback function that is executed if the req succeeds.
        /// </param>
        /// <param name="type" type="String">
    ...
    jQuery.getJSON = function (url, data, callback) {
        /// <summary>
        ///     Load JSON-encoded data from the server using a GET HTTP req.
        /// </summary>
        /// <param name="url" type="String">
        ///     A string containing the URL to which the req is sent.
        /// </param>
    ...
    jQuery.getScript = function (url, callback) {
        /// <summary>
        ///     Load a JavaScript file from the server using a GET HTTP req, then execute it.
        /// </summary>
        /// <param name="url" type="String">
        ///     A string containing the URL to which the req is sent.
        /// </param>
    ...
    jQuery.param = function (a, traditional) {
        /// <summary>
        ///     Create a serialized representation of an array or object, suitable for use in a URL query string or Ajax req.
        ///     &#10;1 - jQuery.param(obj) 
    ...
    jQuery.post = function (url, data, callback, type) {
        /// <summary>
        ///     Load data from the server using a HTTP POST req.
        /// </summary>
        /// <param name="url" type="String">
        ///     A string containing the URL to which the req is sent.
        /// </param>
    ...
    jQuery.prototype.ajaxSend = function (fn) {
        /// <summary>
        ///     Attach a function to be executed before an Ajax req is sent. This is an Ajax Event.
        /// </summary>
        /// <param name="fn" type="Function">
        ///     The function to be invoked.
        /// </param>
    ...
    jQuery.prototype.ajaxStart = function (fn) {
        /// <summary>
        ///     Register a handler to be called when the first Ajax req begins. This is an Ajax Event.
        /// </summary>
        /// <param name="fn" type="Function">
        ///     The function to be invoked.
        /// </param>
    ...
    jQuery.prototype.ajaxSuccess = function (fn) {
        /// <summary>
        ///     Attach a function to be executed whenever an Ajax req completes successfully. This is an Ajax Event.
        /// </summary>
        /// <param name="fn" type="Function">
        ///     The function to be invoked.
        /// </param>
    ...
    jQuery.prototype.height = function (margin, value) {
        ...
        return jQuery.access(this, function (elem, type, value) {
            ...
            if (jQuery.isWindow(elem)) {
                ...
                // isn't a whole lot we can do. See pull req at this URL for discussion:
    ...
    jQuery.prototype.load = function (url, params, callback) {
        ...
        /// </param>
        /// <param name="callback" type="Function">
        ///     A callback function that is executed when the req completes.
        /// </param>
        /// <returns type="jQuery" />
        ...
        // If we have elements to modify, make the req
        if (self.length > 0) {
            jQuery.ajax({
                url: url,
